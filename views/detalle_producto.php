			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="../backend/<?php echo $producto['imagen_url']; ?>" alt="<?php echo $producto['titulo']; ?>">
					</div>
				</div>
				<div class="col-md-7">
					<div class="single-product-content">
						<h3><?php echo $producto['titulo']; ?></h3>
						<p class="single-product-pricing">$<?php echo number_format($producto['precio'], 2); ?><span>COP/kg</span></p>
						<p><?php echo $producto['descripcion']; ?></p>
						<div class="single-product-form">
							<p><strong>Categoria: </strong>Fruta, verdura</p>
							<a href="carrito.php?id=<?php echo $producto['id']; ?>" class="cart-btn"><i class="fas fa-shopping-cart"></i> Agregar al Carrito</a>
						</div>

					</div>
				</div>
				<div class="detalle-campesino">
					<h3>Información del Campesino</h3>
					<p><strong>Nombre:</strong> <?php echo $producto['nombre'] . " " . $producto['apellidos']; ?></p>
					<p><strong>Email:</strong> <?php echo $producto['correo']; ?></p>
					<p><strong>Teléfono:</strong> <?php echo $producto['telefono']; ?></p>
					<p><strong>Direccion:</strong> <?php echo $producto['direccion']; ?></p>
					<p><strong>Departamento:</strong> <?php echo $producto['departamento']; ?></p>
					<p><strong>Municipio:</strong> <?php echo $producto['municipio']; ?></p>
				</div>
			</div>
		</div>
	</div>
