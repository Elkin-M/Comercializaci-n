<?php
// Obtener los IDs del producto y del campesino desde la URL
$id_producto = $_GET['id_producto'];
$campesino_id = $_GET['campesino_id'];
?>
...
<head>
	...
	<!-- title -->
	<title>Pedido - Comercio del Caribe</title>
								...
								<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
									<div class="card-body">
										<div class="billing-address-form">
											<form action="../backend/guardar_cliente.php" method="POST">
												<!-- Campos ocultos para pasar id_producto y campesino_id al backend -->
												<input type="hidden" name="id_producto" value="<?php echo $id_producto; ?>">
												<input type="hidden" name="campesino_id" value="<?php echo $campesino_id; ?>">

												<!-- Campos de información del cliente -->
												<p><input type="text" name="nombre_cliente" placeholder="Nombre Completo" required></p>
												<p><input type="text" name="cedula" placeholder="Cédula" required></p>
												...
												<button class="btn btn-link collapsed" type="submit">
													Guardar Cliente y Pedido
												</button>
											</form>
										</div>
									</div>
